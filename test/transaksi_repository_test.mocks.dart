...
// in mobilepos_app/test/transaksi_repository_test.dart.
...
class _FakeBlueThermalPrinter_2 extends _i1.SmartFake
    implements _i3.BlueThermalPrinter {
  _FakeBlueThermalPrinter_2(
    Object parent,
    Invocation parentInvocation,
  ) : super(
          parent,
...
///
/// See the documentation for Mockito's code generation for more information.
class MockPrinterService extends _i1.Mock implements _i9.PrinterService {
  MockPrinterService() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i3.BlueThermalPrinter get printer => (super.noSuchMethod(
        Invocation.getter(#printer),
        returnValue: _FakeBlueThermalPrinter_2(
          this,
          Invocation.getter(#printer),
        ),
      ) as _i3.BlueThermalPrinter);

  @override
  set selectedPrinter(_i3.BluetoothDevice? _selectedPrinter) =>
      super.noSuchMethod(
        Invocation.setter(
          #selectedPrinter,
          _selectedPrinter,
  ...
  @override
  _i5.Future<List<_i3.BluetoothDevice>> getPairedDevices() =>
      (super.noSuchMethod(
        Invocation.method(
          #getPairedDevices,
          [],
        ),
        returnValue: _i5.Future<List<_i3.BluetoothDevice>>.value(
            <_i3.BluetoothDevice>[]),
      ) as _i5.Future<List<_i3.BluetoothDevice>>);

  @override
  _i5.Future<bool> connectToPrinter(_i3.BluetoothDevice? device) =>
      (super.noSuchMethod(
        Invocation.method(
          #connectToPrinter,
          [device],
  ...
  @override
  _i5.Future<bool> isPrinterConnected() => (super.noSuchMethod(
        Invocation.method(
          #isPrinterConnected,
          [],
        ),
  ...
  @override
  String generateNoTransaksi() => (super.noSuchMethod(
        Invocation.method(
          #generateNoTransaksi,
          [],
        ),
  ...
  @override
  _i5.Future<void> printReceipt({
    required List<_i10.BarangTransaksi>? items,
